                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="删除"><i
                                            class="fa fa-trash-o" onclick="location.href='${pageContext.request.contextPath}/product/delete.do'"></i> 删除
                                    </button>
                                    ...
                                    <a href="${pageContext.request.contextPath}/product/delete.do" class="btn bg-olive btn-xs">ssssss</a>
                                </div>
                            </div>
                        </div>
